...
import com.example.examplemod.registry.BlocksRegistry;
import com.example.examplemod.registry.EffectsRegistry;
import com.example.examplemod.registry.ItemsRegistry;
...
public class ExampleMod
{
    ...
    public static final CreativeModeTab CreativeTab = new CreativeModeTab(MOD_ID) {
        ...
        public ItemStack makeIcon() {
            return new ItemStack(BlocksRegistry.MY_BLOCK.get());
        }
    };
    public ExampleMod()
    {
